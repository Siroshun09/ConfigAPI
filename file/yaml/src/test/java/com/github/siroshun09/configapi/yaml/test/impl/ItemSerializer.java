...
public class ItemSerializer implements Serializer<Item> {
    ...
    public @NotNull Configuration serialize(@NotNull Item item) throws SerializationException {
    ...
    @Override
    public @NotNull Item deserialize(@NotNull Configuration source) throws DeserializationException {
