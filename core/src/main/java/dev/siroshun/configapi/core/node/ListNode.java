...
public sealed interface ListNode extends CommentableNode<List<Node<?>>> permits ListNodeImpl {
    ...
    /**
     * Adds new nodes in the given {@link ListNode} to this {@link ListNode}.
     *
     * @param listNode a {@link ListNode} that includes new nodes to add
     */
     ...
     * @return {@code true} if this {@link ListNode} is changed, otherwise {@code false}
     */
